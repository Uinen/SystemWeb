...
namespace SystemWeb.Repository
{
    public static class TankRepository
    {
        ...
        {
            var context = new MyDbContext();
            PvTank result = context.PvTank.Where(o => o.PvTankId == value.PvTankId).FirstOrDefault();
            if (result != null)
            {
        ...
        public static void Update(List<PvTank> value)
        {
            ...
            {
                var context = new MyDbContext();
                PvTank result = context.PvTank.Where(o => o.PvTankId == temp.PvTankId).FirstOrDefault();
                if (result != null)
                {
