namespace GestioniDirette.Service
{
    using System.Text;
    ...
    public class BrowserConfigService : IBrowserConfigService
    {
        ...
        public string GetBrowserConfigXml()
        {
            ...
            string square70x70logoUrl = this.urlHelper.Content("~/Contenuti/icons/mstile-70x70.png");
            // The URL to the 150x150 medium tile image.
            string square150x150logoUrl = this.urlHelper.Content("~/Contenuti/icons/mstile-150x150.png");
            // The URL to the 310x310 large tile image.
            string square310x310logoUrl = this.urlHelper.Content("~/Contenuti/icons/mstile-310x310.png");
            // The URL to the 310x150 wide tile image.
            string wide310x150logoUrl = this.urlHelper.Content("~/Contenuti/icons/mstile-310x150.png");
