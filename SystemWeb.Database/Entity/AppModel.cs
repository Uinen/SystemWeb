...
namespace SystemWeb.Database.Entity
{
    ...
    public class Carico
    {
        ...
        [ScriptIgnore]
        public Documento Tipo { get; set; }

        [ScriptIgnore]
        public Deposito Depot { get; set; }
        ...
        */
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PvProfile>().HasRequired(p => p.Pv)
                ...
                .HasForeignKey(p => p.pvID);
            modelBuilder.Entity<Carico>().HasRequired(p => p.Depot)
                .WithMany(b => b.Carico)
                .HasForeignKey(p => p.Deposito);
            modelBuilder.Entity<Carico>().HasRequired(p => p.Tipo)
                .WithMany(b => b.Carico)
